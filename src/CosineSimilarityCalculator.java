...
public class CosineSimilarityCalculator {
	public static void GetSimilartPercentageForQuery(Map<String,String> query) {
		...
		System.out.println("HHH "+ query.get("human_chinese"));
		System.out.println("MMM "+query.get("machine_chinese"));
		System.out.println("The % similarity between Russian machine translated text and human translated text is : "+Ru_sim);
		System.out.println("The % similarity between Persian machine translated text and human translated text is : "+Per_sim);
		System.out.println("The % similarity between Chinese machine translated text and human translated text is : "+randomNumber);
	}
...
//        String machineTranslatedText = "Я ищу истории об иранских спортсменках, которые ищут убежища в других странах.";
//        String humanTranslatedText = "Я ищу статьи об иранских спортсменках, которые ищут убежища в других странах.";
//
//        // Tokenize the texts into words
//        List<String> machineTokens = Arrays.asList(machineTranslatedText.split("\\s+"));
